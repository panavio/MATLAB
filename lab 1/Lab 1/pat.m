...
% array elements. Index must not exceed 6. (where 6 is the highest bounds)
% 
...
%a=linspace(-3,7,101) %can use this?
y=zeros(101,1);
...
%{
 as x approaches infinity, there are several solutions to y. These are 
 y=-1, y=1, y=2
